...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/09/2025 às 16:08
...
--
-- Estrutura para tabela `anaesplicido_programacao`
--

CREATE TABLE `anaesplicido_programacao` (
  `id` int(10) NOT NULL,
...
--
-- Índices de tabela `anaesplicido_programacao`
--
ALTER TABLE `anaesplicido_programacao`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `anaesplicido_programacao`
--
ALTER TABLE `anaesplicido_programacao`
